...
BasketScreenWidgetModel defaultBasketScreenWidgetModelFactory(BuildContext context) {
  return BasketScreenWidgetModel(BasketScreenModel(context.read()));
}

// TODO: cover with documentation
/// Default widget model for BasketScreenWidget
class BasketScreenWidgetModel extends WidgetModel<BasketScreenWidget, BasketScreenModel>
