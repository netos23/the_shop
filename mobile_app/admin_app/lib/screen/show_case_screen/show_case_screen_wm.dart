...
ShowCaseScreenWidgetModel defaultShowCaseScreenWidgetModelFactory(BuildContext context) {
  return ShowCaseScreenWidgetModel(ShowCaseScreenModel(context.read()));
}

// TODO: cover with documentation
/// Default widget model for ShowCaseScreenWidget
class ShowCaseScreenWidgetModel extends WidgetModel<ShowCaseScreenWidget, ShowCaseScreenModel>
