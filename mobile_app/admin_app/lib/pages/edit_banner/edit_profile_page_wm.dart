...
abstract class IEditBannerPageWidgetModel extends IWidgetModel
...
EditBannerPageWidgetModel defaultEditBannerPageWidgetModelFactory(
    BuildContext context) {
  return EditBannerPageWidgetModel(EditBannerPageModel());
}

// TODO: cover with documentation
/// Default widget model for EditProfilePageWidget
class EditBannerPageWidgetModel
    extends WidgetModel<EditBannerPageWidget, EditBannerPageModel>
    with ThemeProvider
    implements IEditBannerPageWidgetModel {
  EditBannerPageWidgetModel(EditBannerPageModel model) : super(model);
