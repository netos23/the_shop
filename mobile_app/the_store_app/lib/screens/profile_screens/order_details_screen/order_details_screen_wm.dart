...
abstract class IOrderDetailsScreenWidgetModel extends IWidgetModel
  ...
  EntityStateNotifier<MyOrderDto> get orderState;
...
class OrderDetailsScreenWidgetModel
  ...
  Future<void> _getOrders() async{
    ...
    try{
      ...
      context.showSnackBar("Не удалось получить данные о заказе. Пробуем ещё раз");
    }
  }

  @override
  EntityStateNotifier<MyOrderDto> orderState = EntityStateNotifier<MyOrderDto>();
