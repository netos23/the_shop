...
/// Main widget for StartingMethodPage module
@RoutePage<DeliveryMethod>()
class StartingMethodPageWidget
    extends ElementaryWidget<IStartingMethodPageWidgetModel> {
  const StartingMethodPageWidget({
    Key? key,
    WidgetModelFactory wmFactory =
        defaultStartingMethodPageWidgetModelFactory,
  }) : super(wmFactory, key: key);

  @override
  Widget build(IStartingMethodPageWidgetModel wm) {
