...
class _$_Payment implements _Payment {
  _$_Payment({required this.id, required this.type, required this.picture});
  ...
  @override
  String toString() {
    return 'Payment(id: $id, type: $type, picture: $picture)';
  }
...
abstract class _Payment implements Payment {
  factory _Payment(
      ...
      required final String picture}) = _$_Payment;
