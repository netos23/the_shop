  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    StartingMethodRoute.name: (routeData) {
      ...
      return AutoRoutePage<DeliveryMethod>(
        routeData: routeData,
        child: StartingMethodPageWidget(
          key: args.key,
          wmFactory: args.wmFactory,
        ),
      );
...
class CityListRoute extends PageRouteInfo<CityListRouteArgs> {
  CityListRoute({
    ...
    WidgetModel<ElementaryWidget<IWidgetModel>, ElementaryModel> Function(
            BuildContext)
        wmFactory = defaultCityListPageWidgetModelFactory,
...
class CityListRouteArgs {
  const CityListRouteArgs({
    this.key,
    this.wmFactory = defaultCityListPageWidgetModelFactory,
  });
...
/// generated route for
/// [StartingMethodPageWidget]
class StartingMethodRoute extends PageRouteInfo<StartingMethodRouteArgs> {
  StartingMethodRoute({
    Key? key,
    WidgetModel<ElementaryWidget<IWidgetModel>, ElementaryModel> Function(
            BuildContext)
        wmFactory = defaultStartingMethodPageWidgetModelFactory,
    List<PageRouteInfo>? children,
  }) : super(
...
class StartingMethodRouteArgs {
  const StartingMethodRouteArgs({
    this.key,
    this.wmFactory = defaultStartingMethodPageWidgetModelFactory,
  });
...
class MapPointsRoute extends PageRouteInfo<MapPointsRouteArgs> {
  MapPointsRoute({
    ...
    WidgetModel<ElementaryWidget<IWidgetModel>, ElementaryModel> Function(
            BuildContext)
        wmFactory = defaultMapPointsPageWidgetModelFactory,
    List<PageRouteInfo>? children,
  }) : super(
          MapPointsRoute.name,
...
class MapPointsRouteArgs {
  const MapPointsRouteArgs({
    this.key,
    this.wmFactory = defaultMapPointsPageWidgetModelFactory,
  });
...
class OnboardingRoute extends PageRouteInfo<OnboardingRouteArgs> {
  OnboardingRoute({
    ...
    WidgetModel<ElementaryWidget<IWidgetModel>, ElementaryModel> Function(
            BuildContext)
        wmFactory = defaultOnboardingPageWidgetModelFactory,
    List<PageRouteInfo>? children,
  }) : super(
...
class OnboardingRouteArgs {
  const OnboardingRouteArgs({
    ...
    this.wmFactory = defaultOnboardingPageWidgetModelFactory,
  });
...
class AddressRoute extends PageRouteInfo<AddressRouteArgs> {
  AddressRoute({
    ...
    WidgetModel<ElementaryWidget<IWidgetModel>, ElementaryModel> Function(
            BuildContext)
        wmFactory = defaultAddressPageWidgetModelFactory,
    List<PageRouteInfo>? children,
  }) : super(
          AddressRoute.name,
...
class AddressRouteArgs {
  const AddressRouteArgs({
    this.key,
    this.wmFactory = defaultAddressPageWidgetModelFactory,
  });
...
class FavouriteRoute extends PageRouteInfo<FavouriteRouteArgs> {
  FavouriteRoute({
    ...
    WidgetModel<ElementaryWidget<IWidgetModel>, ElementaryModel> Function(
            BuildContext)
        wmFactory = defaultFavouritePageWidgetModelFactory,
    List<PageRouteInfo>? children,
  }) : super(
          FavouriteRoute.name,
  ...
  static const PageInfo<FavouriteRouteArgs> page =
      PageInfo<FavouriteRouteArgs>(name);
}

class FavouriteRouteArgs {
  const FavouriteRouteArgs({
    this.key,
    this.wmFactory = defaultFavouritePageWidgetModelFactory,
  });
  ...
  @override
  String toString() {
    return 'FavouriteRouteArgs{key: $key, wmFactory: $wmFactory}';
  }
}
